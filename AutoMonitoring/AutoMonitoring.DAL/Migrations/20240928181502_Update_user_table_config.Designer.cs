...
namespace AutoMonitoring.DAL.Migrations
{
    ...
    [Migration("20240928181502_Update_user_table_config")]
    partial class Update_user_table_config
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoMonitoring.Domain.Entities.Implementations.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("f15c0d09-5a65-4723-9082-fd3d730aa0c8"),
                            IsDeleted = false,
                            Name = "Resident"
                        });
                });
            ...
            modelBuilder.Entity("AutoMonitoring.Domain.Entities.Implementations.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("929a92ea-5759-4311-97fd-dab727004f1a"),
                            IsDeleted = false,
